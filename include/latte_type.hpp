...
struct is_integer_
    : std::integral_constant<
        bool,
        std::is_same<short int, typename std::decay<T>::type>::value || std::is_same<unsigned short int, typename std::decay<T>::type>::value || std::is_same<unsigned int, typename std::decay<T>::type>::value || std::is_same<int, typename std::decay<T>::type>::value || std::is_same<long int, typename std::decay<T>::type>::value || std::is_same<unsigned int, typename std::decay<T>::type>::value || std::is_same<unsigned long int, typename std::decay<T>::type>::value || std::is_same<long long int, typename std::decay<T>::type>::value || std::is_same<unsigned long long int, typename std::decay<T>::type>::value> {};

template <class T>
struct is_floating_point_
    : std::integral_constant<
        bool,
        std::is_same<double, typename std::decay<T>::type>::value || std::is_same<long double, typename std::decay<T>::type>::value || std::is_same<float, typename std::decay<T>::type>::value> {};
